        ...
        <div className="grid gap-4 lg:grid-cols-[380px_1fr]">
          ...
          <div className="app-card overflow-hidden">
            ...
            >
              {shown.map((task) => {
                const prio =
                  PRIO_META[task.priority as keyof typeof PRIO_META] ??
                  PRIO_META.low;
                ...
                return (
                  ...
                  >
                    <div className="mb-1.5 flex items-center gap-2">
                      <span
                        className={`app-badge app-badge-sq tone-${prio.tone}`}
                        style={{ height: 18 }}
                      >
                        優先度 {prio.label}
                      </span>
                    ...
                    <div className="mono t-tiny truncate mt-0.5">
                      {task.identifier}
                    </div>
                    <div className="mt-2 flex items-center gap-2">
                      <Avatar user={task.requestedBy} size={20} />
                      <span className="t-tiny">
                        {userById[task.requestedBy]?.name}
                      </span>
            ...
            <div className="app-card-pad" key={active.id}>
              ...
              <div className="mb-5 flex flex-col justify-between gap-3 sm:flex-row sm:items-start">
                <div className="min-w-0">
                  <div className="mono truncate text-[15px] font-semibold">
                    {active.identifier}
                  </div>
              ...
              <div className="mb-5 flex flex-wrap gap-3">
                <div
                  ...
                  style={{ minWidth: 200, background: "var(--surface-2)" }}
                >
                ...
                >
                  ...
                  <span
                    className="app-badge app-badge-sq tone-info"
                    style={{ height: 22 }}
                  >
                    {active.stage}
                  </span>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="t-tiny">
                    {userById[active.requestedBy]?.org} ·{" "}
                    {fmtDate(active.requestedAt, true)}
                  </div>
                </div>
              </div>
